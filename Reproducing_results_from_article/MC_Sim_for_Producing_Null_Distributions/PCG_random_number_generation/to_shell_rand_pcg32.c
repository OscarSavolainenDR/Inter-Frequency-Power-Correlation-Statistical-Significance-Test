 ...
 */
 ...
 // This function was edited by Oscar Savolainen. Originally, it was pcg32-demo.c. This produces and prints PCG 32-bit random numbers, given the seeds and sequence length.
...
int main(int argc, char** argv)
{
    ...
    // 2nd will be seed1
    // 3rd will be seed2
    // if 2nd and 3rd inputs are empty, the sequence is deterministic
