function [all_r_phase, all_f] = arbitrary_get_FT_phase_ran(x_all,Fs,max_MCs_per_channel,thresh_for_corr_inclusion, clip_epsilon)
...
%     clipping = 0.001;
    for syn_signal = 1:length(x_all(1,:))
        ...
        %% FT Phase-randomisation MC simulation
